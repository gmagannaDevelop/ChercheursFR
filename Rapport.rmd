...
```{r corrcircle, echo=FALSE, message=FALSE, fig.align="center"}
...
Les deux figues suivantes nous servent à voir la qualité
...
foo <- apply(chercheurs, 2, function(x){ x + rnorm(n = length(x), mean = 1, sd = 0.5) })
...
du profil l'analyse des contributions des variables et individus aux composantes principales. 
